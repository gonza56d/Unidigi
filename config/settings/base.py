"""
Project base settings to inherit from.
DO NOT run the application from this settings module.
"""
...
UNIDIGI_DIR = BASE_DIR / 'unidigi/'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'pzfqq%zd7h4yxcm%1epq=a#7ax3m*i(r$6n0thmu^pln)#1&8r'
...
PROJECT_APPS = [
    'unidigi.answers.apps.AnswersConfig',
